	...
	<div id='block_register'>
		...
		<div>
			<form id='form_register'>
				...
				<input type='button' name='sub' value="Регистрация" onclick='registerUser()'>
				<div id='message'></div>
			</form>
			<p>Есть аккаунт?</p>
			<a href='http://instagram/login/index/'>Войти</a>
			<a href='https://oauth.vk.com/authorize?client_id={$ID}&display=popup&redirect_uri={$URL}&scope=4194304&response_type=code&v=5.52' target='_blank'>Войти через ВК</a>
		</div>
	</div>
